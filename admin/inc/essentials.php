<?php 
  ...
  // Frontend data
define('SITE_URL', 'http://127.0.0.1/NepalNivas/images/');  // Updated for new folder
...
define('UPLOAD_IMAGE_PATH', $_SERVER['DOCUMENT_ROOT'] . '/NepalNivas/images/');  // Updated for new folder
